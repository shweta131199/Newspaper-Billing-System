...
public class showreport1 extends JFrame implements ActionListener
    {
	 JLabel name;
     JTable table;
     JScrollPane jsp;
	 ...
	 showreport1(String data[][])  //
	 {
	  ...
	  String cname[]={ "Bill_no", "S_ID", "S_NAME", "TOTAL_AMT", "BILL_DATE"};
